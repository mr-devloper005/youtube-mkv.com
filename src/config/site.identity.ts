export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'youtube-mkv',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Youtube Mkv',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'youtube-mkv.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://youtube-mkv.com',
